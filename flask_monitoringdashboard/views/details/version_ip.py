...
from flask_monitoringdashboard.database.count import count_ip, count_versions
...
def version_ip(end):
    with session_scope() as db_session:
        ...
        form = get_double_slider_form([count_ip(db_session, end), count_versions(db_session, end)],
