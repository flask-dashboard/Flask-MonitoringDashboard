...
register(ExceptionInfoFactory, 'exception_info', exception_msg=LazyFixture('exception_message'), exception_type=LazyFixture('exception_type'), full_stack_trace=LazyFixture('full_stack_trace'))
