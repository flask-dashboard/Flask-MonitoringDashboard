...
class TestEndpoint(unittest.TestCase):
    ...
    def test_get_line_results(self):
        ...
        """
        from dashboard.database.endpoint import get_line_results
    ...
    def test_get_num_requests(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_num_requests
    ...
    def test_get_endpoint_column(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_endpoint_column
    ...
    def test_get_endpoint_column_user_sorted(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_endpoint_column_user_sorted
        from dashboard.database import FunctionCall
    ...
    def test_get_endpoint_results(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_endpoint_results
        from dashboard.database import FunctionCall
    ...
    def test_get_monitor_rule(self):
        ...
        """
        from dashboard.database.endpoint import get_monitor_rule
    ...
    def test_update_monitor_rule(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_monitor_rule, update_monitor_rule
    ...
    def test_get_all_measurement(self):
        ...
        """
        from dashboard import config
        from dashboard.database.endpoint import get_all_measurement
    ...
    def test_get_all_measurement_per_column(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_all_measurement_per_column
        from dashboard.database import FunctionCall
        from dashboard import config
    ...
    def test_get_last_accessed_times(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.endpoint import get_last_accessed_times
    ...
    def test_update_last_accessed(self):
        ...
        from dashboard.database.endpoint import update_last_accessed, get_last_accessed_times
