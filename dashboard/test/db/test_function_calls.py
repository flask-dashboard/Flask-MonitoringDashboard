...
class TestFunctionCall(unittest.TestCase):
    ...
    def test_get_data_from(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_data_from
    ...
    def test_get_data(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_data, config
        result = get_data()
    ...
    def test_get_data_per_version(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_data_per_version, config
        new_version = 1.1
    ...
    def test_get_versions(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_versions, config
        result = get_versions()
        self.assertEqual(len(result), 1)
    ...
    def test_get_data_per_endpoint(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_data_per_endpoint
        new_name = 'main2'
    ...
    def test_get_endpoints(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.function_calls import get_endpoints
