...
from dashboard.test.utils import set_test_environment, clear_db, add_fake_data, NAME
...
class TestMonitorRule(unittest.TestCase):
    ...
    def test_get_monitor_names(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.monitor_rules import get_monitor_names
    ...
    def test_get_monitor_data(self):
        """
            Test whether the function returns the right values.
        """
        from dashboard.database.monitor_rules import get_monitor_rules, get_monitor_data
